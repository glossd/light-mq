...
type PublisherClient interface {
	// todo look into client streaming
...
func (c *publisherClient) Send(ctx context.Context, in *MessageRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
...
func (*UnimplementedPublisherServer) Send(context.Context, *MessageRequest) (*MessageResponse, error) {
...
func _Publisher_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublisherServer).Send(ctx, req.(*MessageRequest))
	}
...
var _Publisher_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/lmq/publish.proto",
}
